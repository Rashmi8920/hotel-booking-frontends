  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-white h-full px-4">
        ...
        {/* Search Bar */}
        <div className="mt-8 w-[318px] sm:p-4 p-2 max-w-[50rem] sm:w-[80%] md:w-[60%] bg-white rounded-lg shadow-lg flex items-center sm:space-x-4 space-x-2 sm:mr-0 mr-46">
          <input
            type="text"
