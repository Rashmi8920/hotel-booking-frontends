...
const CartPage = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full p-6 gap-8 bg-gray-50">
      ...
      <div className="w-full sm:ml-0 ml-[-50px] lg:w-2/3 bg-white p-6 rounded-lg">
        <h2 className="text-3xl font-bold mb-6 text-gray-800 sm:ml-0 ml-[58px]">Your Cart</h2>
        {cart.length > 0 ? (
          cart.map((product) => {
          ...
          <p className="text-gray-500 text-center mt-6 sm:mr-0 mr-[25px]">Your cart is empty.</p>
        )}
      </div>
